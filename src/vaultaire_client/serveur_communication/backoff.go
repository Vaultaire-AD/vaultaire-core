...
//
// L'agent réessayait toutes les 30 secondes, indéfiniment, sans variation.
//
...
// NewBackoff démarre une nouvelle suite.
func NewBackoff() *Backoff { return &Backoff{delai: DelaiInitial} }
