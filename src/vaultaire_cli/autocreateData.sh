...
vaultaire create -u alice secret123 06/02/1992 alice@company.com
vaultaire create -u bob strongpass 09/12/1988 bob@company.com
vaultaire create -u fiona mypass321 08/07/1985 fiona@company.com
vaultaire create -u julie loginme 10/09/1994 julie@company.com
vaultaire create -u charlie admin987 03/09/1995 charlie@company.com
vaultaire create -u diana pass456 01/07/1990 diana@company.com
vaultaire create -u eric devpass99 30/01/1993 eric@company.com
vaultaire create -u george testme! 12/11/1997 george@company.com
vaultaire create -u hannah welcome1 04/02/1991 hannah@company.com
vaultaire create -u isaac vault123 05/03/1989 isaac@company.com
vaultaire create -u proxmox_ldap_account secret123 06/01/2004 
