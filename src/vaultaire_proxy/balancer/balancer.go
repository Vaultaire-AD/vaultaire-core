...
func (b *Balancer) Cores() []ducky.CoreInfo {
	b.mu.RLock()
	defer b.mu.RUnlock()
	out := make([]ducky.CoreInfo, len(b.cores))
	copy(out, b.cores)
	return out
}
